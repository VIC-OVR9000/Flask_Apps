...
Open `app.py` and modify the `SCHEMA_GROUPS` and `APP_TITLE` variables to fit your specific use case. (It comes pre-loaded with a Grocery Store Ledger template).
