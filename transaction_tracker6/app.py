...
# ==========================================
APP_TITLE = "The Architect | IT Service Desk"

SCHEMA_GROUPS = {
    "Ticket Identity & Requester": [
        "Ticket_Number", "Created_Date", "Requester_Name", 
        "Requester_Department", "Contact_Email_Phone", "Location_or_Site"
    ],
    "Issue Classification": [
        "Issue_Category", "Sub_Category", "Short_Description", 
        "Impact_Level", "Urgency_Level", "Calculated_Priority"
    ],
    "Assignment & SLA Tracking": [
        "Current_Status", "Assigned_Technician", "Support_Tier_Group", 
        "SLA_Deadline", "SLA_Breached_Flag", "Last_Updated_Date"
    ],
    "Asset & Configuration (CMDB)": [
        "Associated_Asset_Tag", "Device_Type_Model", "Operating_System", 
        "IP_or_MAC_Address", "Warranty_Status"
    ],
    "Work Logs & Communication": [
        "Initial_Troubleshooting_Steps", "Vendor_Ticket_Reference", 
        "Pending_Reason", "User_Communication_Log"
    ],
    "Resolution & Post-Mortem": [
        "Resolution_Code", "Root_Cause_Identified", "Total_Hours_Logged", 
        "Date_Resolved", "Knowledge_Base_Article_Created", "Resolution_Notes"
    ]
}
...
LEDGER_HEADERS = [
    "Ticket_Number", "Created_Date", "Requester_Name", 
    "Issue_Category", "Calculated_Priority", "Current_Status"
]
