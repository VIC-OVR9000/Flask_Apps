...
# ==========================================
APP_TITLE = "The Architect | RE Tax Ledger"

SCHEMA_GROUPS = {
    "Property Identification": [
        "Property_Address", "APN_Parcel_ID", "Property_Type", 
        "Holding_Entity_Name", "Entity_EIN", "Ownership_Percentage"
    ],
    "Acquisition & Disposition": [
        "Purchase_Date", "Purchase_Price", "Placed_In_Service_Date", 
        "Sale_Date", "Sale_Price", "Closing_Costs", "Exchange_1031_Status"
    ],
    "Financing & Debt": [
        "Lender_Name", "Original_Loan_Amount", "Interest_Rate", 
        "Mortgage_Interest_Paid_1098", "PMI_Paid", "Loan_Points_Amortized", 
        "Refinance_Date"
    ],
    "Operating Income & Expenses": [
        "Gross_Rental_Income", "Other_Income_Fees", "Property_Taxes_Paid", 
        "HOA_Dues", "Hazard_Insurance_Premiums", "Utilities_Paid", 
        "Repairs_and_Maintenance", "Property_Management_Fees", "Legal_and_Professional_Fees"
    ],
    "Capitalization & Depreciation": [
        "Allocated_Land_Value", "Depreciable_Building_Basis", "MACRS_Recovery_Period", 
        "Current_Year_Depreciation", "Accumulated_Depreciation", "CapEx_Improvements", 
        "Bonus_or_Section_179_Taken"
    ],
    "Tax Position & Compliance": [
        "Tax_Year", "Net_Taxable_Income_Loss", "Passive_Activity_Loss_Carryover", 
        "RE_Professional_Status_Elected", "QBI_Deduction_Eligibility", 
        "Filing_Form_Sched_E_or_8825", "Federal_Return_Status", "State_Return_Status"
    ],
    "Accountant Logs": [
        "Audit_Risk_Flag", "Missing_Client_Documents", 
        "Client_Sign_Off_Date", "Preparer_Notes"
    ]
}
...
LEDGER_HEADERS = [
    "Tax_Year", "Holding_Entity_Name", "Property_Address", 
    "Gross_Rental_Income", "Net_Taxable_Income_Loss", "Federal_Return_Status"
]

# Limit the Ledger view to the first 6 fields so the table doesn't overflow
LEDGER_HEADERS = ALL_FIELDS[:6]
